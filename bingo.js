...
var _user$project$Bingo$initialEntries = {
	ctor: '::',
	_0: A4(_user$project$Bingo$Entry, 1, 'Stuff', 100, false),
	_1: {
		ctor: '::',
		_0: A4(_user$project$Bingo$Entry, 2, 'Things', 200, false),
		_1: {
			ctor: '::',
			_0: A4(_user$project$Bingo$Entry, 3, 'Foo', 300, false),
			_1: {
				ctor: '::',
				_0: A4(_user$project$Bingo$Entry, 4, 'Bar', 400, false),
				_1: {ctor: '[]'}
			}
		}
	}
};
var _user$project$Bingo$initialModel = {name: 'Mark', gameNumber: 1, entries: _user$project$Bingo$initialEntries};
...
if (typeof _user$project$Bingo$main !== 'undefined') {
    _user$project$Bingo$main(Elm['Bingo'], 'Bingo', {"types":{"unions":{"Bingo.Msg":{"args":[],"tags":{"NewRandom":["Int"],"NewGame":[],"Mark":["Int"]}}},"aliases":{},"message":"Bingo.Msg"},"versions":{"elm":"0.18.0"}});
}
