...
var _user$project$Bingo$viewFooter = A2(
	...
	{ctor: '[]'},
	{
		...
		_0: A2(
			...
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$href('http://google.com'),
				_1: {ctor: '[]'}
			},
			{
				ctor: '::',
...
var _user$project$Bingo$update = F2(
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			default:
				var markEntry = function (entry) {
					return _elm_lang$core$Native_Utils.eq(entry.id, _p0._0) ? _elm_lang$core$Native_Utils.update(
						entry,
...
var _user$project$Bingo$viewEntry = function (entry) {
	return A2(
...
var _user$project$Bingo$viewEntryList = function (entries) {
	return A2(
		...
		{ctor: '[]'},
		A2(_elm_lang$core$List$map, _user$project$Bingo$viewEntry, entries));
};
...
if (typeof _user$project$Bingo$main !== 'undefined') {
    _user$project$Bingo$main(Elm['Bingo'], 'Bingo', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Bingo.Msg":{"args":[],"tags":{"NewRandom":["Int"],"NewGame":[],"Mark":["Int"],"NewEntries":["Result.Result Http.Error (List Bingo.Entry)"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Bingo.Entry":{"args":[],"type":"{ id : Int, phrase : String, points : Int, marked : Bool }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"}},"message":"Bingo.Msg"},"versions":{"elm":"0.18.0"}});
}
